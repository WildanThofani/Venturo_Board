...
class OnpressedSaldoKasLanda extends StatefulWidget {
  @override
  OnpressedSaldoKasLandaState createState() => OnpressedSaldoKasLandaState();
}

class OnpressedSaldoKasLandaState extends State<OnpressedSaldoKasLanda> {
  ...
  Future ambilHeaderSaldoKas(DateTime dt) async {
    var data = await http
        .get('https://accsystems.landa.co.id/api/acc/l_buku_besar/laporan?'
                'endDate=2020-' +
            bulanInt +
            '-31'
