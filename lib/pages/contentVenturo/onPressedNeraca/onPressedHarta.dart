...
class OnPressedHartaVenturo extends StatefulWidget {
  OnPressedHartaVenturo({Key key}) : super(key: key);

  @override
  _OnPressedHartaVenturoState createState() =>
      _OnPressedHartaVenturoState();
}


class _OnPressedHartaVenturoState extends State<OnPressedHartaVenturo> {
