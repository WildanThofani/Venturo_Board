...
import 'package:wajib_baca/pages/contentVenturo/onPressedCashflow/onPressedCashFlow.dart';
import 'package:wajib_baca/pages/contentVenturo/onPressedCashflow/onPressedCashIn.dart';
import 'package:wajib_baca/pages/contentVenturo/onPressedCashflow/onPressedCashOut.dart';
import 'package:wajib_baca/pages/contentVenturo/onPressedNeraca/onPressedHarta.dart';
import 'package:wajib_baca/pages/contentVenturo/onPressedNeraca/onPressedHutang.dart';
import 'package:wajib_baca/pages/contentVenturo/onPressedNeraca/onPressedModal.dart';
import 'package:wajib_baca/pages/contentVenturo/onPressedProfitLoss/onPressedExpense.dart';
import 'package:wajib_baca/pages/contentVenturo/onPressedProfitLoss/onPressedProfitLoss.dart';
import 'package:wajib_baca/pages/contentVenturo/onPressedProfitLoss/onPressedRevenue.dart';
import 'package:wajib_baca/pages/contentVenturo/salesOverdue.dart';

class ProfitLossVenturo extends StatefulWidget {
  ProfitLossVenturo({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ProfitLossVenturoState createState() => _ProfitLossVenturoState();
}

class _ProfitLossVenturoState extends State<ProfitLossVenturo> {
                  ...
                  child: InkWell(
                    onTap: (){
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ExpenseVenturo()));
                    },
                    child: Column(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child:
                                FutureBuilder(
                                  future: getProfitLossVen(nowGlobalService),
                                  ...
                                  FutureBuilder(
                                    ...
                                    builder: (BuildContext context, snapshot) {
                                      ...
                                      if (snapshot.hasData) {
                                        ...
                                        var totalPendapatan = pendapatan
                                            // + pendapatanDU
                                        ;
                    ...
                    InkWell(
                      onTap: (){
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => OnPressedCashFlowVenturo()));
                      },
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: <Widget>[
                          Padding(
                            padding: const EdgeInsets.only(top: 15, bottom: 8),
                            child: FutureBuilder(
                              future: getCashFlowTotalVen(nowGlobalService),
                              builder: (BuildContext context, snapshot) {
                                if (snapshot.hasData &&
                                    snapshot.connectionState == ConnectionState.done) {
                              ...
                              child: Column(
                                children: <Widget>[
                                  Padding(
                                    ...
                                    child: FutureBuilder(
                                        future: getCashflowPenerimaanVen(nowGlobalService),
                                        builder: (BuildContext context, snapshot) {
                            ...
                            InkWell(
                              onTap: (){
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => CashOutVenturo()));
                              },
                              child: Column(
                                children: <Widget>[
                                  Padding(
                                    padding: const EdgeInsets.only(bottom: 2),
                                    child: FutureBuilder(
                                      future: getCashflowPengeluaranVen(nowGlobalService),
                                      builder: (BuildContext context, snapshot) {
                                        if (snapshot.hasData &&
                                            snapshot.connectionState == ConnectionState.done) {
                                          if (snapshot.data['data']['data']['total'].length == 0) {
                        ...
                        InkWell(
                          onTap: (){
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => OnPressedHartaVenturo()));
                          },
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child:
                                FutureBuilder(
                                  future: getnNeracaVen(nowGlobalService),
                                  builder: (BuildContext context, snapshot) {
                                    if (snapshot.hasData &&
                                        snapshot.connectionState == ConnectionState.done) {
