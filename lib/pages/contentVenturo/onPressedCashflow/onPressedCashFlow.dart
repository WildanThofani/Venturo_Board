...
class OnPressedCashFlowVenturo extends StatefulWidget{
  OnPressedCashFlowVenturo({Key key}) : super(key: key);

  @override
  _OnPressedCashFlowVenturoState createState() => _OnPressedCashFlowVenturoState();
}

class _OnPressedCashFlowVenturoState extends State<OnPressedCashFlowVenturo> {
