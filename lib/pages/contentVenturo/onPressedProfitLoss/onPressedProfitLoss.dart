...
class OnPressedProfitLossVenturo extends StatefulWidget{
  OnPressedProfitLossVenturo({Key key}) : super(key: key);

  @override
  _OnPressedProfitLossVenturoState createState() => _OnPressedProfitLossVenturoState();
}
...
_getTotal(DateTime dt) async {
  ...
  var response = await http.get(
      'https://accventuro.landa.co.id/api/acc/l_laba_rugi/laporan?'
          'endDate=2020-' + bulanInt + '-31'
          '&export=0&is_detail=1&lokasi_nama=Landa+System&m_lokasi_id=1&print=0&'
          'startDate=2020-' + bulanInt + '-01');
...
class _OnPressedProfitLossVenturoState extends State<OnPressedProfitLossVenturo> {
