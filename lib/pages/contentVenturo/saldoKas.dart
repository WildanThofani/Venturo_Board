...
import 'package:wajib_baca/pages/contentVenturo/onPressedSaldoKas/onPressedSaldoKas.dart';

class SaldoKasVenturo extends StatefulWidget {
  SaldoKasVenturo({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _SaldoKasVenturoState createState() => _SaldoKasVenturoState();
}

class _SaldoKasVenturoState extends State<SaldoKasVenturo> {
  ...
  Widget build(BuildContext context) {
    ...
    _getSaldoKas() async {
      var response = await http.get(
          "https://accventuro.landa.co.id/api/site/getSaldoAkun");
                                                        ...
                                                        InkWell(
                                                          onTap: (){
                                                            Navigator.push(
                                                                context,
                                                                MaterialPageRoute(
                                                                    builder: (context) => OnpressedSaldoKasVenturo()));
                                                          },
                                                          child: Row(
                                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
