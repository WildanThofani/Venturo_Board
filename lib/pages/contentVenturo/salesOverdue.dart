...
import 'package:wajib_baca/pages/contentVenturo/onPressedSalesOverdue/onPressedSalesOverdue.dart';


import '../sales_overdue_all.dart';

class SalesOverdueVenturo extends StatefulWidget {
  SalesOverdueVenturo({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _SalesOverdueVenturoState createState() => _SalesOverdueVenturoState();
}

class _SalesOverdueVenturoState extends State<SalesOverdueVenturo> {
  Widget build(BuildContext context) {
    var size = MediaQuery.of(context).size;

    _getSalesOverdue() async{
      var response = await http.get(
          "http://2019-venturo.landa.co.id/api/laporanpiutang/index?status_lunas=belum_lunas"
      );
                      ...
                      child: FlatButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => OnPressedSalesOverdueVenturo()));
                        },
                      ),
                    )
                  ],
