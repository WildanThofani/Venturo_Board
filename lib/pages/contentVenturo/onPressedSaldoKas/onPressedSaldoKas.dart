...
class OnpressedSaldoKasVenturo extends StatefulWidget {
  @override
  OnpressedSaldoKasVenturoState createState() => OnpressedSaldoKasVenturoState();


}

class OnpressedSaldoKasVenturoState extends State<OnpressedSaldoKasVenturo> {
  ...
  Future ambilHeaderSaldoKas(DateTime dt) async {
    var data = await http
        .get('https://accventuro.landa.co.id/api/acc/l_buku_besar/laporan?'
        'endDate=2020-' +
        bulanInt +
        '-31'
