...
class OnPressedCashFlowWajibBaca extends StatefulWidget{
  OnPressedCashFlowWajibBaca({Key key}) : super(key: key);

  @override
  _OnPressedCashFlowWajibBacaState createState() => _OnPressedCashFlowWajibBacaState();
}

class _OnPressedCashFlowWajibBacaState extends State<OnPressedCashFlowWajibBaca> {
