...
import 'package:wajib_baca/pages/contentWajibBaca/onPressedCashflow/onPressedCashFlow.dart';
import 'package:wajib_baca/pages/contentWajibBaca/onPressedCashflow/onPressedCashOut.dart';
import 'package:wajib_baca/pages/contentWajibBaca/onPressedNeraca/onPressedHutang.dart';
import 'package:wajib_baca/pages/contentWajibBaca/onPressedProfitLoss/onPressedProfitLoss.dart';
import 'package:wajib_baca/pages/contentWajibBaca/onPressedProfitLoss/onPressedRevenue.dart';
import 'package:wajib_baca/pages/contentWajibBaca/salesOverdue.dart';

import 'onPressedCashflow/onPressedCashIn.dart';
import 'onPressedNeraca/onPressedHarta.dart';
import 'onPressedNeraca/onPressedModal.dart';
import 'onPressedProfitLoss/onPressedExpense.dart';

class ProfitLossWajibBaca extends StatefulWidget {
  ProfitLossWajibBaca({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ProfitLossWajibBacaState createState() => _ProfitLossWajibBacaState();
}

class _ProfitLossWajibBacaState extends State<ProfitLossWajibBaca> {
                  ...
                  child: InkWell(
                    onTap: (){
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ExpenseWajibBaca()));
                    },
                    child: Column(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child:
                                FutureBuilder(
                                  future: getProfitLossWB(nowGlobalService),
                    ...
                    InkWell(
                      onTap: (){
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => OnPressedCashFlowWajibBaca()));
                      },
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: <Widget>[
                          Padding(
                            padding: const EdgeInsets.only(top: 15, bottom: 8),
                            child: FutureBuilder(
                              future: getCashFlowTotalWB(nowGlobalService),
                              builder: (BuildContext context, snapshot) {
                                if (snapshot.hasData &&
                                    snapshot.connectionState == ConnectionState.done) {
                            ...
                            InkWell(
                              onTap: (){
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => CashInWajibBaca()));
                              },
                              child: Column(
                                children: <Widget>[
                                  Padding(
                                    ...
                                    child: FutureBuilder(
                                        future: getCashflowPenerimaanWB(nowGlobalService),
                                        builder: (BuildContext context, snapshot) {
                            ...
                            InkWell(
                              onTap: (){
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => CashOutWajibBaca()));
                              },
                              child: Column(
                                children: <Widget>[
                                  Padding(
                                    padding: const EdgeInsets.only(bottom: 2),
                                    child: FutureBuilder(
                                      future: getCashflowPengeluaranWB(nowGlobalService),
                                      builder: (BuildContext context, snapshot) {
                                        if (snapshot.hasData &&
                                            snapshot.connectionState == ConnectionState.done) {
                                          if (snapshot.data['data']['data']['total'].length == 0) {
                        ...
                        InkWell(
                          onTap: (){
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => OnPressedHartaWajibBaca()));
                          },
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child:
                                FutureBuilder(
                                  future: getnNeracaWB(nowGlobalService),
                                  builder: (BuildContext context, snapshot) {
                                    if (snapshot.hasData &&
                                        snapshot.connectionState == ConnectionState.done) {
                            ...
                            InkWell(
                              onTap: (){
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => ModalWajibBaca()));
                              },
                              child: Column(
                                children: <Widget>[
                                  FutureBuilder(
                            ...
                            InkWell(
                              onTap: (){
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => HutangWajibBaca()));
                              },
                              child: Column(
                                children: <Widget>[
                                  FutureBuilder(
