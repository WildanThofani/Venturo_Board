...
class OnpressedSaldoKasWajibBaca extends StatefulWidget {
  @override
  OnpressedSaldoKasWajibBacaState createState() => OnpressedSaldoKasWajibBacaState();


}

class OnpressedSaldoKasWajibBacaState extends State<OnpressedSaldoKasWajibBaca> {
  ...
  Future ambilHeaderSaldoKas(DateTime dt) async {
    var data = await http
        .get('https://accwb.landa.co.id/api/acc/l_buku_besar/laporan?'
        'endDate=2020-' +
        bulanInt +
        '-31'
