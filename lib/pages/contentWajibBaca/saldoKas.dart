...
import 'package:wajib_baca/pages/contentWajibBaca/onPressedSaldoKas/onPressedSaldoKas.dart';

class SaldoKasWajibBaca extends StatefulWidget {
  SaldoKasWajibBaca({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _SaldoKasWajibBacaState createState() => _SaldoKasWajibBacaState();
}

class _SaldoKasWajibBacaState extends State<SaldoKasWajibBaca> {
  ...
  Widget build(BuildContext context) {
    ...
    _getSaldoKas() async {
      var response = await http.get(
          "https://accwb.landa.co.id/api/site/getSaldoAkun");
                                                        ...
                                                        InkWell(
                                                          onTap: (){
                                                            Navigator.push(
                                                                context,
                                                                MaterialPageRoute(
                                                                    builder: (context) => OnpressedSaldoKasWajibBaca()));
                                                          },
                                                          child: Row(
                                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
