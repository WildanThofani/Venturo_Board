...
class OnPressedProfitLossWajibBaca extends StatefulWidget{
  OnPressedProfitLossWajibBaca({Key key}) : super(key: key);

  @override
  _OnPressedProfitLossWajibBacaState createState() => _OnPressedProfitLossWajibBacaState();
}
...
Future _getRevenue(DateTime dt) async {
  var data = await http.get('https://accwb.landa.co.id/api/acc/l_laba_rugi/laporan?'
...
_getTotal(DateTime dt) async {
  ...
  var response = await http.get(
      'https://accwb.landa.co.id/api/acc/l_laba_rugi/laporan?'
          'endDate=2020-' + bulanInt + '-31'
          '&export=0&is_detail=1&lokasi_nama=Landa+System&m_lokasi_id=1&print=0&'
          'startDate=2020-' + bulanInt + '-01');
...
class _OnPressedProfitLossWajibBacaState extends State<OnPressedProfitLossWajibBaca> {
