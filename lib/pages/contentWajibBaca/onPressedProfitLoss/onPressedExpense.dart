...
class ExpenseWajibBaca extends StatefulWidget {
  @override
  ExpenseWajibBacaState createState() => ExpenseWajibBacaState();


}


class ExpenseWajibBacaState extends State<ExpenseWajibBaca> {
