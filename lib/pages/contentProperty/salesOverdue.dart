...
import 'package:wajib_baca/pages/contentProperty/onPressedSalesOverdue/onPressedSalesOverdue.dart';


import '../sales_overdue_all.dart';

class SalesOverdueProperty extends StatefulWidget {
  SalesOverdueProperty({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _SalesOverduePropertyState createState() => _SalesOverduePropertyState();
}

class _SalesOverduePropertyState extends State<SalesOverdueProperty> {
  Widget build(BuildContext context) {
    var size = MediaQuery.of(context).size;

    _getSalesOverdue() async{
      var response = await http.get(
          "http://2019-rain.landa.co.id/api/laporanpiutang/index?status_lunas=belum_lunas"
      );
                      ...
                      child: FlatButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => OnPressedSalesOverdueProperty()));
                        },
                      ),
                    )
                  ],
