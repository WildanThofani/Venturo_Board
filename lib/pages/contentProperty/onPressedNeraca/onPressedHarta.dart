...
class OnPressedHartaProperty extends StatefulWidget {
  OnPressedHartaProperty({Key key}) : super(key: key);

  @override
  _OnPressedHartaPropertyState createState() =>
      _OnPressedHartaPropertyState();
}


class _OnPressedHartaPropertyState extends State<OnPressedHartaProperty> {
  ...
  Future ambilHartaBank(DateTime dt) async {
    var data = await http.get('https://accproptech.landa.co.id/api/acc/l_neraca/laporan?export=0&is_detail=1&lokasi_nama=Landa+System&m_lokasi_id=1&print=0&'
