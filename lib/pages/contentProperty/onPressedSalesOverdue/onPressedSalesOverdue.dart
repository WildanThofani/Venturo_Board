...
class OnPressedSalesOverdueProperty extends StatefulWidget {
  @override
  OnPressedSalesOverduePropertyState createState() =>
      OnPressedSalesOverduePropertyState();
}

class OnPressedSalesOverduePropertyState extends State<OnPressedSalesOverdueProperty> {
  ...
  Future ambilDetailOverDue() async {
    var data = await http.get(
        'https://2019-rain.landa.co.id/api/laporanpiutang/index?status_lunas=belum_lunas');
