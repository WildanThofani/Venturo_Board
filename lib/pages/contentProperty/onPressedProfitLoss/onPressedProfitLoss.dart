...
class OnPressedProfitLossProperty extends StatefulWidget{
  OnPressedProfitLossProperty({Key key}) : super(key: key);

  @override
  _OnPressedProfitLossPropertyState createState() => _OnPressedProfitLossPropertyState();
}
...
class _OnPressedProfitLossPropertyState extends State<OnPressedProfitLossProperty> {
