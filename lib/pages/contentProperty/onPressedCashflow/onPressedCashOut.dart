...
class CashOutProperty extends StatefulWidget {
  @override
  CashOutPropertyState createState() => CashOutPropertyState();


}

class CashOutPropertyState extends State<CashOutProperty> {
